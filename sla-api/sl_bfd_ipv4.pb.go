...
func (*SLBfdv4Key) Descriptor() ([]byte, []int) {
	return fileDescriptor_09c25a2397f6d25a, []int{0}
}
...
func (m *SLBfdv4Key) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv4Key.Merge(m, src)
}
...
func (*SLBfdv4SessionCfg) Descriptor() ([]byte, []int) {
	return fileDescriptor_09c25a2397f6d25a, []int{1}
}
...
func (m *SLBfdv4SessionCfg) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv4SessionCfg.Merge(m, src)
}
...
func (*SLBfdv4Msg) Descriptor() ([]byte, []int) {
	return fileDescriptor_09c25a2397f6d25a, []int{2}
}
...
func (m *SLBfdv4Msg) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv4Msg.Merge(m, src)
}
...
func (*SLBfdv4Res) Descriptor() ([]byte, []int) {
	return fileDescriptor_09c25a2397f6d25a, []int{3}
}
...
func (m *SLBfdv4Res) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv4Res.Merge(m, src)
}
...
func (*SLBfdv4MsgRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_09c25a2397f6d25a, []int{4}
}
...
func (m *SLBfdv4MsgRsp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv4MsgRsp.Merge(m, src)
}
...
func (*SLBfdv4GetMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_09c25a2397f6d25a, []int{5}
}
...
func (m *SLBfdv4GetMsg) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv4GetMsg.Merge(m, src)
}
...
func (*SLBfdv4SessionCfgState) Descriptor() ([]byte, []int) {
	return fileDescriptor_09c25a2397f6d25a, []int{6}
}
...
func (m *SLBfdv4SessionCfgState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv4SessionCfgState.Merge(m, src)
}
...
func (*SLBfdv4GetMsgRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_09c25a2397f6d25a, []int{7}
}
...
func (m *SLBfdv4GetMsgRsp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv4GetMsgRsp.Merge(m, src)
}
...
func (*SLBfdv4SessionState) Descriptor() ([]byte, []int) {
	return fileDescriptor_09c25a2397f6d25a, []int{8}
}
...
func (m *SLBfdv4SessionState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv4SessionState.Merge(m, src)
}
...
func (*SLBfdv4Notif) Descriptor() ([]byte, []int) {
	return fileDescriptor_09c25a2397f6d25a, []int{9}
}
...
func (m *SLBfdv4Notif) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv4Notif.Merge(m, src)
}
...
func init() { proto.RegisterFile("sl_bfd_ipv4.proto", fileDescriptor_09c25a2397f6d25a) }

var fileDescriptor_09c25a2397f6d25a = []byte{
