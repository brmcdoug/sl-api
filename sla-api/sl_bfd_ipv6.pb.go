...
func (*SLBfdv6Key) Descriptor() ([]byte, []int) {
	return fileDescriptor_d79e9c1c6375531b, []int{0}
}
...
func (m *SLBfdv6Key) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv6Key.Merge(m, src)
}
...
func (*SLBfdv6SessionCfg) Descriptor() ([]byte, []int) {
	return fileDescriptor_d79e9c1c6375531b, []int{1}
}
...
func (m *SLBfdv6SessionCfg) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv6SessionCfg.Merge(m, src)
}
...
func (*SLBfdv6Msg) Descriptor() ([]byte, []int) {
	return fileDescriptor_d79e9c1c6375531b, []int{2}
}
...
func (m *SLBfdv6Msg) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv6Msg.Merge(m, src)
}
...
func (*SLBfdv6Res) Descriptor() ([]byte, []int) {
	return fileDescriptor_d79e9c1c6375531b, []int{3}
}
...
func (m *SLBfdv6Res) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv6Res.Merge(m, src)
}
...
func (*SLBfdv6MsgRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_d79e9c1c6375531b, []int{4}
}
...
func (m *SLBfdv6MsgRsp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv6MsgRsp.Merge(m, src)
}
...
func (*SLBfdv6GetMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_d79e9c1c6375531b, []int{5}
}
...
func (m *SLBfdv6GetMsg) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv6GetMsg.Merge(m, src)
}
...
func (*SLBfdv6SessionCfgState) Descriptor() ([]byte, []int) {
	return fileDescriptor_d79e9c1c6375531b, []int{6}
}
...
func (m *SLBfdv6SessionCfgState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv6SessionCfgState.Merge(m, src)
}
...
func (*SLBfdv6GetMsgRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_d79e9c1c6375531b, []int{7}
}
...
func (m *SLBfdv6GetMsgRsp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv6GetMsgRsp.Merge(m, src)
}
...
func (*SLBfdv6SessionState) Descriptor() ([]byte, []int) {
	return fileDescriptor_d79e9c1c6375531b, []int{8}
}
...
func (m *SLBfdv6SessionState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv6SessionState.Merge(m, src)
}
...
func (*SLBfdv6Notif) Descriptor() ([]byte, []int) {
	return fileDescriptor_d79e9c1c6375531b, []int{9}
}
...
func (m *SLBfdv6Notif) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLBfdv6Notif.Merge(m, src)
}
...
func init() { proto.RegisterFile("sl_bfd_ipv6.proto", fileDescriptor_d79e9c1c6375531b) }

var fileDescriptor_d79e9c1c6375531b = []byte{
