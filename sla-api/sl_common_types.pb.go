...
func (SLRegOp) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0dc5f9ccba3a51fd, []int{0}
}
...
func (SLObjectOp) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0dc5f9ccba3a51fd, []int{1}
}
...
func (SLNotifOp) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0dc5f9ccba3a51fd, []int{2}
}
...
func (SLErrorStatus_SLErrno) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0dc5f9ccba3a51fd, []int{0, 0}
}
...
func (m *SLErrorStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLErrorStatus.Merge(m, src)
}
...
func (m *SLInterface) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLInterface.Merge(m, src)
}
...
func (m *SLIpAddress) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLIpAddress.Merge(m, src)
}
...
func init() { proto.RegisterFile("sl_common_types.proto", fileDescriptor_0dc5f9ccba3a51fd) }

var fileDescriptor_0dc5f9ccba3a51fd = []byte{
	// 2282 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0x7c, 0x59, 0xc9, 0x72, 0x1c, 0xb7,
